...
void downloadFile() {
    ...
    for (int i = 0; i <= 100; ++i) {
        ...
        cout << "\r";
        // 打印进度条
        cout << "[" << string(i / 5, '=') << string(20 - i / 5, ' ') << "] " << i << "%";
        // 刷新输出缓冲区，使进度条立即显示
        cout.flush();
        // 模拟下载延迟
...
int main() {
    ...
    cout << "\033]0;全角转半角v0.2\007" << "\033]1;C:\\Users\\16382\\Pictures\\Saved Pictures\\icon.jpg\007";
    ...
    if (input != password) {
        cout << "PIN值错误，程序终止." << endl << endl;
        return 0;
    } else {
        cout << "PIN值正确，允许执行下面操作" << endl << endl;
    }
